...
echo "=== Step 3: Installing initial dependencies ==="
sudo apt update
sudo apt install -y ca-certificates gnupg

echo "=== Step 4: Adding Mono repository keys ==="
...
echo "=== Step 13: Starting and enabling mj12 service ==="
sudo systemctl daemon-reload
sudo systemctl enable mj12.service
sudo systemctl start mj12.service

echo "=== Step 14: Verifying service status ==="
